...
public class Reflect extends TeamwideFieldEffect implements EndsAtEndOfTurn, EffectsIncomingDamage {
    @Override
    ...
    public float damageModifier(Move move) {
        return move.getCategory() == MoveCategory.PHYSICAL ? (1/1.5f) : 1;
    }
}
